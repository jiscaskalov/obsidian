...
tasks.jar {
    manifest {
        ...
        attributes(
            ...
            "Implementation-Title" to "obsidian", // obsidian
            "Implementation-Version" to implementationVersion,
            "Implementation-Vendor" to date,
            "Specification-Title" to "obsidian", // obsidian
            "Specification-Version" to project.version,
            "Specification-Vendor" to "jiscaskalov", // obsidian
            "Brand-Id" to "jiscaskalov:obsidian", // obsidian
            "Brand-Name" to "obsidian", // obsidian
